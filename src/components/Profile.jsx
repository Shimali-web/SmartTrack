          ...
          <div className="mb-3 position-relative">
            {photoURL ? (
              <img
                ...
                style={{ width: 90, height: 90, objectFit: "cover", boxShadow: "0 2px 8px #2563eb33", cursor: "pointer" }}
                onClick={() => fileInputRef.current.click()}
                title="Click to change photo"
              />
            ) : (
              <div
                className="rounded-circle bg-gradient d-inline-flex justify-content-center align-items-center mb-2 border border-3 border-primary"
                style={{
                  width: 90,
                  height: 90,
                  fontSize: "2.7rem",
